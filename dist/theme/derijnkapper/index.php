<?php get_header(); ?><div class="grid"><div class="grid__item two-thirds lap-one-whole palm-one-whole"><div class="article-wrapper"><?php if(have_posts()): while(have_posts()): the_post(); ?><article class="peeled"><a href="<?php the_permalink(); ?>"><h2><?php the_title(); ?></h2></a> <?php
			the_content();
			...
			?><div class="frontslide-item reltv"><div class="img-wrap"><img class="lazyOwl" data-src="<?php
					...
					edit_post_link('Bewerken');
					 ?></article></div><?php endwhile; endif; ?></div></div><div class="grid__item one-third lap-one-whole palm-one-whole sidebar"><?php get_sidebar(); ?></div></div><footer class="page-footer"><?php get_footer(); ?></footer>